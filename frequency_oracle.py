...
class Frequency_oracle(object):
    ...
    '''
    def __init__(self, data, frequency_oracle_name = None, epsilon = None, domain_size=None, merged_domain = None):
        '''
        Args:
    ...
    def _sw(self, ori_samples, l, h, eps, randomized_bins=1024, domain_bins=1024, smooth = True):
        ...
        self.ns_hist = ns_hist
        self.transform = transform
        self.n = n
        self.max_iteration = max_iteration
        self.loglikelihood_threshold = loglikelihood_threshold
        if smooth is None:
